...
def load_data():
    ...
    marca_toyota = Marca.objects.create(nombre_marca="Toyota")
    modelo_corolla = Modelo.objects.create(nombre_modelo="Corolla", marca=marca_toyota)
    ...
    calificacion = Calificacion.objects.create(
        id_calificacion=1, id_arr=arriendo, puntaje=5, comentario="Muy buen servicio"
    )
